# Generated by Django 2.0.2 on 2018-03-25 19:41
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('book_condition', models.CharField(blank=True, choices=[('5', 'test'), ('4', 'test'), ('3', 'test'), ('2', 'test'), ('1', 'test')], default='5', help_text='Book condition', max_length=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(blank=True, choices=[('a', 'Fiction'), ('b', 'Non-Fiction'), ('c', 'Textbook'), ('d', 'History'), ('e', 'Mystery'), ('f', 'History'), ('g', 'Sci-Fi')], default='Fiction', help_text='Select a book genre (e.g. Science Fiction, French Poetry etc.)', max_length=200)),
            ],
        ),
        migrations.AddField(
            model_name='book',
